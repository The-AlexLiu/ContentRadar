...
app = FastAPI(
    title="ContentRadar WebUI API",
    description="API for controlling ContentRadar from WebUI",
    version="1.0.0"
)
...
async def serve_frontend():
    ...
    return {
        "message": "ContentRadar WebUI API",
        "version": "1.0.0",
        "docs": "/docs",
...
async def check_environment():
    """Check if ContentRadar environment is configured correctly"""
    try:
        ...
        if process.returncode == 0:
            return {
                "success": True,
                "message": "ContentRadar environment configured correctly",
